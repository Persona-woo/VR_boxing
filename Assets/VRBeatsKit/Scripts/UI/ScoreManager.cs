...
namespace VRBeats
{
    public class ScoreManager : MonoBehaviour
    {
        ...
        private int toNextMultiplierIncrease = 1;
        ...
        private void UpdateUI()
        {
            ...
            comboLabel.text = "Combo x " + currentMultiplier;
            comboLabel.gameObject.SetActive(true);
            
            StopCoroutine("DelayHideLable");
            StartCoroutine("DelayHideLable");
        }

        IEnumerator DelayHideLable()
        {
            yield return 1;
